...
def create_email_recipients(apps, schema_editor):
    ...
    for email_content in EmailContent.objects.all().iterator(chunk_size=500):
        EmailRecipient.objects.create(
            ...
            language_code=email_content.language_code,
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.CharField(db_index=True, default=larpmanager.models.utils.my_uuid, editable=False, max_length=12, unique=True)),
                ...
                ('language_code', models.CharField(blank=True, max_length=50, null=True, verbose_name='Language Code')),
