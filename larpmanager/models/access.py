...
class AssociationRole(BaseModel):
    ...
    permissions = models.ManyToManyField(AssociationPermission, related_name="assoc_roles", blank=True)
...
def get_assoc_inners(association: Association) -> list[Member]:
    ...
    Example:
        ...
        >>> members = get_assoc_inners(association)
        >>> len(members)
        5
    """
    lst = []
