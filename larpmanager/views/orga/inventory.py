...
from larpmanager.utils.core.common import get_element_event, get_elements
...
def orga_ci_inventory(request: HttpRequest, event_slug: str) -> HttpResponse:
    ...
    context["list"] = get_elements(context["event"].id, Inventory).order_by("number")
...
def orga_ci_pool_types(request: HttpRequest, event_slug: str) -> HttpResponse:
    ...
    context["list"] = get_elements(context["event"].id, PoolType).order_by("number")
...
def orga_ci_inventory_types(request: HttpRequest, event_slug: str) -> HttpResponse:
    ...
    context["list"] = get_elements(context["event"].id, InventoryType).order_by("number")
...
def orga_ci_pool_labels(request: HttpRequest, event_slug: str) -> HttpResponse:
    ...
    context["list"] = get_elements(context["event"].id, PoolLabel).order_by("number")
