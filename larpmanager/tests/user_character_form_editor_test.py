...
async def field_single(page, live_server):
    ...
    await page.locator("#id_name").fill("single")
    ...
    await page.get_by_role("link", name="New").click()
    await page.locator("#id_name").click()
    await page.locator("#id_name").fill("rrrr")
    await page.get_by_role("button", name="Confirm", exact=True).click()

    await page.get_by_role("link", name="New").click()
    await page.locator("#id_name").click()
    await page.locator("#id_name").fill("wwww")
    await page.get_by_role("button", name="Confirm", exact=True).click()
...
async def field_multiple(page, live_server):
    ...
    await page.locator("#id_name").click()
    await page.locator("#id_name").fill("rrrrrr")
    await page.locator("#id_max_length").click()
    await page.locator("#id_max_length").fill("1")

    await page.get_by_role("link", name="New").click()
    await page.locator("#id_name").click()
    await page.locator("#id_name").fill("q1")
    await page.get_by_role("button", name="Confirm", exact=True).click()

    await page.get_by_role("link", name="New").click()
    await page.locator("#id_name").click()
    await page.locator("#id_name").fill("q2")
    await page.get_by_role("button", name="Confirm", exact=True).click()

    await page.get_by_role("link", name="New").click()
    await page.locator("#id_name").click()
    await page.locator("#id_name").fill("q3")
    await page.get_by_role("button", name="Confirm", exact=True).click()

    await page.get_by_role("link", name="New").click()
    await page.locator("#id_name").click()
    await page.locator("#id_name").fill("14")
    await page.locator("#id_max_available").click()
    await page.locator("#id_max_available").fill("3")
...
async def field_text(page, live_server):
    ...
    await page.locator("#id_name").fill("text")
    await page.locator("#id_max_length").click()
    ...
    await page.locator("#id_name").click()
    await page.locator("#id_name").fill("rrr")
    await page.get_by_role("button", name="Confirm", exact=True).click()
