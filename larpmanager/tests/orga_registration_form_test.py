...
async def add_single(page):
    ...
    await page.get_by_role("link", name="New").click()
    await page.locator("#id_display").click()
    await page.locator("#id_display").fill("free")
    await page.locator("#id_details").click()
    await page.locator("#id_details").fill("free")
    ...
    await page.locator("#id_display").press("Tab")
    await page.locator("#id_details").fill("many")
...
async def add_single_options(page):
    ...
    await page.get_by_role("link", name="New").click()
    await page.locator("#id_display").click()
    await page.locator("#id_display").fill("rescrited")
    await page.locator("#id_display").press("Tab")
    ...
    await page.locator("#id_display").press("Tab")
    await page.locator("#id_details").fill("only")
    await page.locator("#id_details").press("Tab")
    await page.locator("#id_price").fill("20")
    await page.locator("#id_price").press("Tab")
    await page.locator("#id_max_available").fill("1")
...
async def add_multiple(page):
    ...
    await page.locator("#id_display").click()
    await page.locator("#id_display").fill("multiple")
    await page.locator("#id_display").press("Tab")
...
async def signup_first(live_server, page):
    ...
    await page.locator("#id_typ").select_option("t")
    await page.locator("#id_typ").press("Tab")
    await page.locator("#id_display").fill("")
    await page.locator("#id_display").press("CapsLock")
