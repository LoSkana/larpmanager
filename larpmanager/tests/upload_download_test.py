...
def quest_trait(page):
    ...
    check_download(page, "Download example template")
    page.get_by_role("button", name="Choose File").click()
    page.get_by_role("button", name="Choose File").set_input_files(get_path("quest.csv"))
    page.get_by_role("button", name="Submit").click()
    ...
    check_download(page, "Download example template")
    page.get_by_role("button", name="Choose File").click()
    page.get_by_role("button", name="Choose File").set_input_files(get_path("trait.csv"))
    page.get_by_role("button", name="Submit").click()
...
def registrations(page):
    ...
    check_download(page, "Download example template")
    page.get_by_role("button", name="Choose File").click()
    page.get_by_role("button", name="Choose File").set_input_files(get_path("relationships.csv"))
    page.get_by_role("button", name="Choose File").click()
    page.get_by_role("button", name="Choose File").set_input_files(get_path("registration.csv"))
    page.get_by_role("button", name="Submit").click()
...
def reg_form(page):
    ...
    page.get_by_role("link", name="Upload").click()
    check_download(page, "Download example template")
    page.get_by_role("row", name="Questions Choose File").locator("td").click()
...
def characters(page):
    ...
    check_download(page, "Download example template")
    page.get_by_role("button", name="Choose File").click()
    page.get_by_role("button", name="Choose File").set_input_files(get_path("character.csv"))
    page.get_by_role("button", name="Submit").click()
...
def factions(page):
    ...
    check_download(page, "Download example template")
    page.get_by_role("button", name="Choose File").click()
    page.get_by_role("button", name="Choose File").set_input_files(get_path("faction.csv"))
    page.get_by_role("button", name="Submit").click()
