...
def test_orga_character_form(live_server):
    with sync_playwright() as p:
        ...
        try:
            orga_character_form(live_server, page)

        except Exception as e:
            handle_error(page, e, "orga_character_form")
...
def orga_character_form(live_server, page):
...
def show_chars(page, live_server):
    ...
    page.locator("#id_show_teaser").check()
    page.locator("#id_show_text").check()
    page.get_by_role("button", name="Confirm", exact=True).click()
...
def add_field_special(page):
    ...
    page.locator("#id_display").fill("mandatory")
    ...
    page.locator("#id_typ").select_option("t")
    page.locator("#id_typ").press("Tab")
    page.locator("#id_display").fill("disabled")
    page.locator("#id_display").press("Tab")
    ...
    page.locator("#id_typ").select_option("t")
    page.locator("#id_typ").press("Tab")
    page.locator("#id_display").fill("hidden")
    page.locator("#id_display").press("Tab")
    ...
    page.locator("#id_typ").select_option("t")
    page.locator("#id_typ").press("Tab")
    page.locator("#id_display").fill("public")
    page.locator("#id_display").press("Tab")
    ...
    page.locator("#id_typ").select_option("t")
    page.locator("#id_typ").press("Tab")
    page.locator("#id_display").fill("only creation")
    page.locator("#id_display").press("Tab")
...
def add_field_restricted(page):
    ...
    page.locator("#id_display").fill("restricted")
    page.locator("#id_display").press("Tab")
    page.locator("#id_description").fill("restricted text")
    page.get_by_role("link", name="New").click()
    page.locator("#id_display").click()
    page.locator("#id_display").fill("all")
    page.locator("#id_display").press("Tab")
    page.locator("#id_details").fill("all descr")
    page.locator("#id_details").press("Tab")
    page.get_by_role("button", name="Confirm", exact=True).click()
    page.get_by_role("link", name="New").click()
    page.locator("#id_display").click()
    page.locator("#id_display").fill("few")
    page.locator("#id_display").press("Tab")
    page.locator("#id_details").fill("few descr")
    page.locator("#id_details").press("Tab")
    ...
    page.locator('[id="\\38 "]').get_by_role("link", name="").click()
    page.get_by_role("link", name="").click()
    page.get_by_role("row", name=" few").get_by_role("link").click()
    page.locator("#id_display").click()
    page.locator("#id_display").fill("w")
    page.locator("#id_display").press("Home")
    page.locator("#id_display").fill("only")
    page.locator("#id_display").press("Tab")
...
def add_field_multiple(page):
    ...
    page.locator("#id_display").click()
    page.locator("#id_display").fill("multiple text")
    page.locator("#id_display").press("Tab")
    ...
    page.get_by_role("link", name="New").click()
    page.locator("#id_display").click()
    page.locator("#id_display").fill("many")
    page.locator("#id_display").press("Tab")
    page.locator("#id_details").fill("many descr")
    page.locator("#id_details").press("Tab")
    page.locator("#id_max_available").fill("2")
    page.get_by_role("button", name="Confirm", exact=True).click()
    page.get_by_text("New Search List").click()
    page.get_by_role("link", name="New").click()
    page.locator("#id_display").click()
    page.locator("#id_display").fill("few")
    page.locator("#id_display").press("Tab")
    page.locator("#id_details").fill("few")
    page.locator("#id_details").press("Tab")
    page.locator("#id_details").click()
    page.locator("#id_details").press("ArrowRight")
    page.locator("#id_details").fill("few descr")
    page.locator("#id_details").press("Tab")
    page.locator("#id_max_available").fill("1")
    page.get_by_role("button", name="Confirm", exact=True).click()
...
def add_field_available(page):
    page.get_by_role("link", name="New").click()
    page.locator("#id_display").click()
    page.locator("#id_display").fill("available text")
    page.locator("#id_display").press("Tab")
    ...
    page.locator("#id_display").fill("all")
    page.locator("#id_display").press("Tab")
    page.locator("#id_details").fill("all")
    page.locator("#id_details").press("Tab")
    page.get_by_role("button", name="Confirm", exact=True).click()
    page.get_by_text("New Search List").click()
    page.get_by_role("link", name="New").click()
...
def add_field_text(page):
    ...
    page.locator("#id_typ").select_option("t")
    page.locator("#id_typ").press("Tab")
    page.locator("#id_display").fill("short text")
    page.locator("#id_display").press("Tab")
    ...
    page.locator("#id_typ").press("Tab")
    page.locator("#id_display").fill("long text")
    page.locator("#id_display").press("Tab")
