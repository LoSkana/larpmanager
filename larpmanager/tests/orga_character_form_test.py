...
async def add_field_special(page):
    ...
    await page.locator("#id_display").fill("mandatory")
    ...
    await page.locator("#id_typ").select_option("t")
    await page.locator("#id_typ").press("Tab")
    await page.locator("#id_display").fill("disabled")
    await page.locator("#id_display").press("Tab")
    ...
    await page.locator("#id_typ").select_option("t")
    await page.locator("#id_typ").press("Tab")
    await page.locator("#id_display").fill("hidden")
    await page.locator("#id_display").press("Tab")
    ...
    await page.locator("#id_typ").select_option("t")
    await page.locator("#id_typ").press("Tab")
    await page.locator("#id_display").fill("public")
    await page.locator("#id_display").press("Tab")
    ...
    await page.locator("#id_typ").select_option("t")
    await page.locator("#id_typ").press("Tab")
    await page.locator("#id_display").fill("only creation")
    await page.locator("#id_display").press("Tab")
...
async def add_field_restricted(page):
    ...
    await page.locator("#id_display").fill("restricted")
    await page.locator("#id_display").press("Tab")
    await page.locator("#id_description").fill("restricted text")
    await page.get_by_role("link", name="New").click()
    await page.locator("#id_display").click()
    await page.locator("#id_display").fill("all")
    await page.locator("#id_display").press("Tab")
    await page.locator("#id_details").fill("all descr")
    await page.locator("#id_details").press("Tab")
    await page.get_by_role("button", name="Confirm", exact=True).click()
    await page.get_by_role("link", name="New").click()
    await page.locator("#id_display").click()
    await page.locator("#id_display").fill("few")
    await page.locator("#id_display").press("Tab")
    await page.locator("#id_details").fill("few descr")
    await page.locator("#id_details").press("Tab")
    ...
    await page.locator("#id_display").fill("only")
    await page.locator("#id_display").press("Tab")
    await page.locator("#id_details").press("Home")
    await page.locator("#id_details").fill("only descr")
    await page.get_by_role("button", name="Confirm", exact=True).click()
    await page.get_by_role("button", name="Confirm", exact=True).click()
...
async def add_field_multiple(page):
    ...
    await page.locator("#id_display").click()
    await page.locator("#id_display").fill("multiple text")
    await page.locator("#id_display").press("Tab")
    ...
    await page.get_by_role("link", name="New").click()
    await page.locator("#id_display").click()
    await page.locator("#id_display").fill("many")
    await page.locator("#id_display").press("Tab")
    await page.locator("#id_details").fill("many descr")
    await page.locator("#id_details").press("Tab")
    await page.locator("#id_max_available").fill("2")
    await page.get_by_role("button", name="Confirm", exact=True).click()
    await page.get_by_text("New Search List").click()
    await page.get_by_role("link", name="New").click()
    await page.locator("#id_display").click()
    await page.locator("#id_display").fill("few")
    await page.locator("#id_display").press("Tab")
    await page.locator("#id_details").fill("few")
    await page.locator("#id_details").press("Tab")
    await page.locator("#id_details").click()
    await page.locator("#id_details").press("ArrowRight")
    await page.locator("#id_details").fill("few descr")
    await page.locator("#id_details").press("Tab")
    await page.locator("#id_max_available").fill("1")
    await page.get_by_role("button", name="Confirm", exact=True).click()
...
async def add_field_available(page):
    await page.get_by_role("link", name="New").click()
    await page.locator("#id_display").click()
    await page.locator("#id_display").fill("available text")
    await page.locator("#id_display").press("Tab")
    ...
    await page.locator("#id_display").fill("all")
    await page.locator("#id_display").press("Tab")
    await page.locator("#id_details").fill("all")
    await page.locator("#id_details").press("Tab")
    await page.get_by_role("button", name="Confirm", exact=True).click()
    await page.get_by_text("New Search List").click()
    await page.get_by_role("link", name="New").click()
...
async def add_field_text(page):
    ...
    await page.locator("#id_typ").select_option("t")
    await page.locator("#id_typ").press("Tab")
    await page.locator("#id_display").fill("short text")
    await page.locator("#id_display").press("Tab")
    ...
    await page.locator("#id_typ").press("Tab")
    await page.locator("#id_display").fill("long text")
    await page.locator("#id_display").press("Tab")
