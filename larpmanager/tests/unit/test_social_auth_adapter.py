...
from larpmanager.utils.auth.adapter import MySocialAccountAdapter
...
class TestSocialAuthAdapter:
    ...
    def test_update_member_populates_name_fields(self) -> None:
        ...
        user = User.objects.create_user(
            username="testuser_populate",
            email="test_populate@example.com",
            password="testpass123"
        )
