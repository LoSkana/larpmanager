...
class TestRegistrationFeeCalculation(BaseTestCase):
    """Test self.registration() fee calculation logic"""

    def test_get_reg_iscr_basic_ticket_only(self):
        """Test fee calculation with basic ticket only"""
        # Basic ticket costs 100.00
        result = get_reg_iscr(self.registration())
    ...
    def test_get_reg_iscr_with_options(self):
        """Test fee calculation with self.registration() options"""
