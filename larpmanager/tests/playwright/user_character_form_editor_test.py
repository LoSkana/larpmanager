...
def field_single(page: Any, live_server: Any) -> None:
    ...
    page.locator("#uglipop_popbox #id_name").fill("ff")
    page.locator("#uglipop_popbox #id_max_available").click()
    page.locator("#uglipop_popbox #id_max_available").fill("3")
    submit_confirm(page, "uglipop_popbox")

    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("#uglipop_popbox #id_name").click()
    page.locator("#uglipop_popbox #id_name").fill("rrrr")
    submit_confirm(page, "uglipop_popbox")

    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("#uglipop_popbox #id_name").click()
    page.locator("#uglipop_popbox #id_name").fill("wwww")
    submit_confirm(page, "uglipop_popbox")
...
def field_multiple(page: Any, live_server: Any) -> None:
    ...
    just_wait(page)
    page.locator("#uglipop_popbox #id_name").click()
    page.locator("#uglipop_popbox #id_name").fill("q1")
    submit_confirm(page, "uglipop_popbox")

    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("#uglipop_popbox #id_name").click()
    page.locator("#uglipop_popbox #id_name").fill("q2")
    submit_confirm(page, "uglipop_popbox")

    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("#uglipop_popbox #id_name").click()
    page.locator("#uglipop_popbox #id_name").fill("q3")
    submit_confirm(page, "uglipop_popbox")

    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("#uglipop_popbox #id_name").click()
    page.locator("#uglipop_popbox #id_name").fill("14")
    page.locator("#uglipop_popbox #id_max_available").click()
    page.locator("#uglipop_popbox #id_max_available").fill("3")
    page.locator("#uglipop_popbox").get_by_role("row", name="Prerequisites").get_by_role("searchbox").fill("ww")
    page.locator("#uglipop_popbox").get_by_role("option", name="Test Larp - single wwww").click()
    submit_confirm(page, "uglipop_popbox")
