...
def field_single(page: Any, live_server: Any) -> None:
    ...
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_name").fill("ff")
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_max_available").click()
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_max_available").fill("3")
    ...
    just_wait(page)
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_name").click()
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_name").fill("rrrr")
    page.locator("#uglipop_popbox iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
    ...
    just_wait(page)
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_name").click()
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_name").fill("wwww")
    page.locator("#uglipop_popbox iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
...
def field_multiple(page: Any, live_server: Any) -> None:
    ...
    just_wait(page)
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_name").click()
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_name").fill("q1")
    page.locator("#uglipop_popbox iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
    ...
    just_wait(page)
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_name").click()
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_name").fill("q2")
    page.locator("#uglipop_popbox iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
    ...
    just_wait(page)
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_name").click()
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_name").fill("q3")
    page.locator("#uglipop_popbox iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
    ...
    just_wait(page)
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_name").click()
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_name").fill("14")
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_max_available").click()
    page.locator("#uglipop_popbox iframe").content_frame.locator("#id_max_available").fill("3")
