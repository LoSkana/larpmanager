...
def field_single(page: Any, live_server: Any) -> None:
    ...
    page.locator("iframe").content_frame.locator("#id_name").fill("ff")
    ...
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").click()
    page.locator("iframe").content_frame.locator("#id_name").fill("rrrr")
    page.locator("iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
    ...
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").click()
    page.locator("iframe").content_frame.locator("#id_name").fill("wwww")
    page.locator("iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
...
def field_multiple(page: Any, live_server: Any) -> None:
    ...
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").click()
    page.locator("iframe").content_frame.locator("#id_name").fill("q1")
    page.locator("iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
    ...
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").click()
    page.locator("iframe").content_frame.locator("#id_name").fill("q2")
    page.locator("iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
    ...
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").click()
    page.locator("iframe").content_frame.locator("#id_name").fill("q3")
    page.locator("iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
    ...
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").click()
    page.locator("iframe").content_frame.locator("#id_name").fill("14")
    page.locator("iframe").content_frame.locator("#id_max_available").click()
    page.locator("iframe").content_frame.locator("#id_max_available").fill("3")
