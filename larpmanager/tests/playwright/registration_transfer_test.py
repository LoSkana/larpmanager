...
def create_event_a(page: Any, live_server: Any) -> None:
    ...
    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").fill("Small")
    page.locator("iframe").content_frame.locator("#id_description").fill("Small size")
    page.locator("iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)

    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").fill("Medium")
    page.locator("iframe").content_frame.locator("#id_description").fill("Medium size")
    page.locator("iframe").content_frame.locator("#id_price").fill("5.00")
    page.locator("iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)

    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").fill("Large")
    page.locator("iframe").content_frame.locator("#id_description").fill("Large size")
    page.locator("iframe").content_frame.locator("#id_price").fill("10.00")
    page.locator("iframe").content_frame.locator("#id_max_available").fill("5")
    page.locator("iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
    ...
    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").fill("Combat")
    page.locator("iframe").content_frame.locator("#id_description").fill("Combat workshop")
    page.locator("iframe").content_frame.locator("#id_price").fill("15.00")
    page.locator("iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)

    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").fill("Makeup")
    page.locator("iframe").content_frame.locator("#id_description").fill("Makeup workshop")
    page.locator("iframe").content_frame.locator("#id_price").fill("20.00")
    page.locator("iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)

    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").fill("Crafting")
    page.locator("iframe").content_frame.locator("#id_description").fill("Crafting workshop")
    page.locator("iframe").content_frame.locator("#id_price").fill("10.00")
    page.locator("iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
