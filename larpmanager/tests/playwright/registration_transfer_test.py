...
def create_event_a(page: Any, live_server: Any) -> None:
    ...
    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("#uglipop_popbox #id_name").fill("Small")
    page.locator("#uglipop_popbox #id_description").fill("Small size")
    submit_confirm(page, "uglipop_popbox")

    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("#uglipop_popbox #id_name").fill("Medium")
    page.locator("#uglipop_popbox #id_description").fill("Medium size")
    page.locator("#uglipop_popbox #id_price").fill("5.00")
    submit_confirm(page, "uglipop_popbox")

    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("#uglipop_popbox #id_name").fill("Large")
    page.locator("#uglipop_popbox #id_description").fill("Large size")
    page.locator("#uglipop_popbox #id_price").fill("10.00")
    page.locator("#uglipop_popbox #id_max_available").fill("5")
    submit_confirm(page, "uglipop_popbox")
    ...
    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("#uglipop_popbox #id_name").fill("Combat")
    page.locator("#uglipop_popbox #id_description").fill("Combat workshop")
    page.locator("#uglipop_popbox #id_price").fill("15.00")
    submit_confirm(page, "uglipop_popbox")

    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("#uglipop_popbox #id_name").fill("Makeup")
    page.locator("#uglipop_popbox #id_description").fill("Makeup workshop")
    page.locator("#uglipop_popbox #id_price").fill("20.00")
    submit_confirm(page, "uglipop_popbox")

    page.get_by_role("link", name="New").click()
    just_wait(page)
    page.locator("#uglipop_popbox #id_name").fill("Crafting")
    page.locator("#uglipop_popbox #id_description").fill("Crafting workshop")
    page.locator("#uglipop_popbox #id_price").fill("10.00")
    submit_confirm(page, "uglipop_popbox")
