...
def check_first_char(page: Any, live_server: Any) -> None:
    ...
    page.locator('#id_que_u6_1').click(force=True)
    page.locator('#id_que_u8_0').click(force=True)
    ...
    expect(page.locator('input[name="que_u6"]:checked')).to_have_value("u2")
    expect(page.locator('input[name="que_u8"]:checked')).to_have_value("u7")
...
def recheck_char(live_server: Any, page: Any) -> None:
    ...
    expect_normalized(page, page.locator("#main_form"), "only only descr all all descr restricted text")
