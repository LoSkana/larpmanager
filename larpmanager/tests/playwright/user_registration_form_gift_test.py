...
def field_choice(page: Any, live_server: Any) -> None:
    ...
    page.locator("#uglipop_popbox #id_description").fill("f")
    page.locator("#uglipop_popbox #id_price").click()
    page.locator("#uglipop_popbox #id_price").click()
    page.locator("#uglipop_popbox #id_price").fill("10")
    page.locator("#uglipop_popbox #id_price").press("Tab")
    page.locator("#uglipop_popbox #id_max_available").fill("2")
    ...
    page.locator("#uglipop_popbox #id_description").fill("s")
    submit_confirm(page, "uglipop_popbox")
...
def field_multiple(page: Any, live_server: Any) -> None:
    ...
    page.locator("#uglipop_popbox #id_name").press("Tab")
    page.locator("#uglipop_popbox #id_description").fill("asdas")
    submit_confirm(page, "uglipop_popbox")
    ...
    page.locator("#uglipop_popbox #id_description").fill("asdas")
    page.locator("#uglipop_popbox #id_price").click()
    page.locator("#uglipop_popbox #id_price").press("Home")
    page.locator("#uglipop_popbox #id_price").fill("10")
    ...
    page.locator("#uglipop_popbox #id_description").click()
    page.locator("#uglipop_popbox #id_description").fill("sarrrr")
    submit_confirm(page, "uglipop_popbox")
