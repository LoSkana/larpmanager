...
def field_choice(page: Any, live_server: Any) -> None:
    ...
    page.locator("iframe").content_frame.locator("#id_name").fill("prima")
    page.locator("iframe").content_frame.locator("#id_name").press("Tab")
    page.locator("iframe").content_frame.locator("#id_description").fill("f")
    page.locator("iframe").content_frame.locator("#id_price").click()
    page.locator("iframe").content_frame.locator("#id_price").click()
    page.locator("iframe").content_frame.locator("#id_price").fill("10")
    page.locator("iframe").content_frame.locator("#id_price").press("Tab")
    ...
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").click()
    page.locator("iframe").content_frame.locator("#id_name").fill("secondas")
    page.locator("iframe").content_frame.locator("#id_description").click()
    page.locator("iframe").content_frame.locator("#id_description").fill("s")
    page.locator("iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
...
def field_multiple(page: Any, live_server: Any) -> None:
    ...
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").click()
    page.locator("iframe").content_frame.locator("#id_name").fill("one")
    page.locator("iframe").content_frame.locator("#id_name").press("Tab")
    page.locator("iframe").content_frame.locator("#id_description").fill("asdas")
    page.locator("iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
    ...
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").click()
    page.locator("iframe").content_frame.locator("#id_name").fill("twp")
    page.locator("iframe").content_frame.locator("#id_name").press("Tab")
    page.locator("iframe").content_frame.locator("#id_description").fill("asdas")
    page.locator("iframe").content_frame.locator("#id_price").click()
    page.locator("iframe").content_frame.locator("#id_price").press("Home")
    page.locator("iframe").content_frame.locator("#id_price").fill("10")
    ...
    just_wait(page)
    page.locator("iframe").content_frame.locator("#id_name").click()
    page.locator("iframe").content_frame.locator("#id_name").fill("hhasd")
    page.locator("iframe").content_frame.locator("#id_description").click()
    page.locator("iframe").content_frame.locator("#id_description").fill("sarrrr")
    page.locator("iframe").content_frame.get_by_role("button", name="Confirm").click()
    just_wait(page)
