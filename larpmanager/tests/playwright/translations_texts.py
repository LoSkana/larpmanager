...
def test_translations_text(pw_page: Any) -> None:
    ...
    page.locator("#id_default").uncheck()
    page.get_by_role("button", name="Confirm").click()
    expect_normalized_text(page.locator("#one"), "Home fr bonjour Home it BUONGIORNO Home en Hello")

    # test languages
    go_to(page, live_server, "/")
    expect_normalized_text(page.locator("#one"), "Hello")
    ...
    expect_normalized_text(page.locator("#one"), "BUONGIORNO")
    expect_normalized_text(page.locator("#topbar"), "Profilo Contabilità")

    go_to(page, live_server, "/language")
    page.get_by_label("Seleziona la lingua:").select_option("fr")
    page.get_by_role("button", name="Submit").click()
    expect_normalized_text(page.locator("#one"), "bonjour")
    expect_normalized_text(page.locator("#topbar"), "Profil Comptabilité")
