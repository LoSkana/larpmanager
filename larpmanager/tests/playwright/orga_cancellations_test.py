...
def refund_with_tokens(live_server: Any, page: Any) -> None:
    ...
    expect_normalized(page, page.locator("body"), "Total: " + str(USER_TOKEN_REFUND))
    login_orga(page, live_server)
...
def refund_with_credits(live_server: Any, page: Any) -> None:
    ...
    go_to(page, live_server, "/accounting/")
    expect_normalized(page, page.locator("body"), "Total: " + str(ORGA_TOKEN_REFUND))
    expect_normalized(page, page.locator("body"), "Total: " + str(ORGA_CREDIT_REFUND))
