...
def test_exe_membership(pw_page: Any) -> None:
    ...
    expect_normalized(page, page.locator("body"), "Total members: 1 - Request: 1")
    expect_normalized(page, page.locator("body"), "Test")
    expect_normalized(page, page.locator("body"), "Admin")
    expect_normalized(page, page.locator("body"), "orga@test.it")
    ...
    # test
    expect_normalized(page, page.locator("body"), "Total members: 1 - Accepted: 1")
    expect_normalized(page, page.locator("body"), "Test")
    expect_normalized(page, page.locator("body"), "Admin")
    expect_normalized(page, page.locator("body"), "orga@test.it")
    expect_normalized(page, page.locator("body"), "Test Larp")
