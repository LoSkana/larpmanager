...
def donation(page: Any, live_server: Any) -> None:
    ...
    go_to(page, live_server, "/accounting")
    expect_normalized(page, page.locator("body"), "Donations done")
...
def membership_fees(page: Any, live_server: Any) -> None:
    ...
    go_to(page, live_server, "/accounting")
    expect_normalized(page, page.locator("body"), "Payment membership fee")
    page.get_by_role("link", name="Pay the annual fee").click()
    page.get_by_role("cell", name="test wire").click()
    submit(page)

    expect_normalized(page, page.locator("body"), "15")
    load_image(page, "#id_invoice")
    page.get_by_role("checkbox", name="Payment confirmation:").check()
    ...
    go_to(page, live_server, "/accounting")
    expect(page.locator("body")).not_to_contain_text("Payment membership fee")
...
def collections(page: Any, live_server: Any) -> None:
    ...
    expect_normalized(page, page.locator("body"), "20")
    load_image(page, "#id_invoice")
    page.get_by_role("checkbox", name="Payment confirmation:").check()
    ...
    go_to(page, live_server, "/manage/invoices")
    expect_normalized(page, page.locator("body"), "Collected contribution of Admin Test for User")
    page.get_by_role("link", name="Confirm").click()
