...
def discount(live_server: Any, page: Any) -> None:
    ...
    expect_normalized_text(page.locator("#regs_u1_Participant"), "100")
    expect_normalized_text(page.locator("#regs_u1_Participant"), "52")
    go_to(page, live_server, "/test/register")
    page.locator("#one").get_by_role("link", name="Accounting").click()
    expect_normalized_text(page.locator("#one"), "Total payments: 100")
    ...
    expect_normalized_text(page.locator("#discount_tbl"), "20.00€")
    page.get_by_role("button", name="Continue").click()
    expect_normalized_text(page.locator("#riepilogo"), "Your updated registration total is: 80€.")
    page.wait_for_timeout(2000)
...
def pay(live_server: Any, page: Any) -> None:
    ...
    go_to(page, live_server, "/test/register")
    page.locator("#one").get_by_role("link", name="Accounting").click()
    expect_normalized_text(page.locator("#one"), "Total registration fee: 100")
    expect_normalized_text(page.locator("#one"), "Total payments: 48")
    expect_normalized_text(page.locator("#one"), "Next payment: 52")
    go_to(page, live_server, "/test/manage/registrations")
    page.get_by_role("link", name="accounting", exact=True).click()
    # Check for registration accounting data in the table
    expect_normalized_text(page.locator("#regs_u1_Participant"), "52")
    expect_normalized_text(page.locator("#regs_u1_Participant"), "48")
    expect_normalized_text(page.locator("#regs_u1_Participant"), "100")

    # pay
    go_to(page, live_server, "/accounting/registration/u1/")
    expect_normalized_text(page.locator("#one"), "100")
    expect_normalized_text(page.locator("#one"), "48")
    expect_normalized_text(page.locator("#one"), "52")
    submit(page)
...
def signup_pay(live_server: Any, page: Any) -> None:
    ...
    submit(page)
    expect_normalized_text(page.locator("#one"), "100")
    expect_normalized_text(page.locator("#one"), "test beneficiary")
    expect_normalized_text(page.locator("#one"), "test iban")
