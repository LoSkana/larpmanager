...
def verify(page: Any, live_server: Any) -> None:
    ...
    expect_normalized(page.locator("#one"), "Total revenue: 133.00")
    expect_normalized(page.locator("#one"), "Net profit: 71.00")
    expect_normalized(page.locator("#one"), "Organization tax: 17.29")
    expect_normalized(page.locator("#one"), "Registrations: 70.00")
    expect_normalized(page.locator("#one"), "Outflows: 62.00")
    expect_normalized(page.locator("#one"), "Inflows: 63.00")
    expect_normalized(page.locator("#one"), "Income: 70.00")
    ...
    expect_normalized(page.locator("#one"), "20.00")
    expect_normalized(page.locator("#one"), "91.00")
    expect_normalized(page.locator("#one"), "70.00")
    expect_normalized(page.locator("#one"), "93.00")
    expect_normalized(page.locator("#one"), "72.00")
    expect_normalized(page.locator("#one"), "10.00")
    expect_normalized(page.locator("#one"), "30.00")
