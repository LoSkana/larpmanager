...
def verify(page: Any, live_server: Any) -> None:
    ...
    expect_normalized(page, page.locator("body"), "Realized revenue: 133.00")
    expect_normalized(page, page.locator("body"), "Net profit: 71.00")
    expect_normalized(page, page.locator("body"), "Organization tax: 17.29")
    expect_normalized(page, page.locator("body"), "Registrations: 70.00")
    expect_normalized(page, page.locator("body"), "Outflows: 62.00")
    expect_normalized(page, page.locator("body"), "Inflows: 63.00")
    expect_normalized(page, page.locator("body"), "Income: 70.00")
    ...
    expect_normalized(page, page.locator("body"), "20.00")
    expect_normalized(page, page.locator("body"), "91.00")
    expect_normalized(page, page.locator("body"), "70.00")
    expect_normalized(page, page.locator("body"), "93.00")
    expect_normalized(page, page.locator("body"), "72.00")
    expect_normalized(page, page.locator("body"), "10.00")
    expect_normalized(page, page.locator("body"), "30.00")
