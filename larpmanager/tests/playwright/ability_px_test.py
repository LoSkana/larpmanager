...
def modifiers(page: Any, live_server: Any) -> None:
    ...
    page.get_by_role("link", name="New").click()
    page.locator("#id_abilities_tr").get_by_role("listitem").click()
    page.locator("#id_abilities_tr").get_by_role("searchbox").fill("do")
    ...
    page.get_by_role("link", name="Modifiers").click()
    page.get_by_role("link", name="New").click()
    page.locator("#id_abilities_tr").get_by_role("searchbox").click()
    page.locator("#id_abilities_tr").get_by_role("searchbox").fill("do")
    page.get_by_role("option", name="double shield").click()
    page.locator("#id_abilities_tr").get_by_role("searchbox").press("Tab")
...
def free_invisible_not_auto_assigned(page: Any, live_server: Any) -> None:
    ...
    page.locator("a").filter(has_text=re.compile(r"^Test Character$")).click()
    page.get_by_role("link", name="Abilities").click()
    expect(page.locator("#page-container")).not_to_contain_text("hidden_zero")
