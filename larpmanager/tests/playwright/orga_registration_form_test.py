...
def add_single(page: Any) -> None:
    ...
    iframe.locator("#id_name").fill("free")
    iframe.locator("#id_description").click()
    iframe.locator("#id_description").fill("free")
    iframe.locator("#id_price").click()
    iframe.locator("#id_price").press("ArrowLeft")
    ...
    iframe.locator("#id_description").fill("many")
    ...
    iframe.locator("#id_price").click()
    iframe.locator("#id_price").press("ArrowLeft")
    iframe.locator("#id_price").fill("30")
    iframe.locator("#id_price").press("Tab")
    ...
    iframe.locator("#id_name").press("Tab")
    iframe.locator("#id_description").fill("only")
    iframe.locator("#id_description").press("Tab")
    iframe.locator("#id_price").fill("20")
    iframe.locator("#id_price").press("Tab")
    iframe.locator("#id_max_available").fill("1")
