...
def signup_check(live_server: Any, page: Any) -> None:
    ...
    expect_normalized(page, page.locator("#register_form"), "choice descrfree freemany manyfew few descr")
    expect(page.get_by_label("rescrited")).to_have_value("u5")
    expect_normalized(page, page.locator("#register_form"), "rescrited descrall all descronly only")
