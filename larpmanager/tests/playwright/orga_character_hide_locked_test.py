...
def _test_character_hide(page: Any, live_server: Any, char_counter: list) -> None:
    ...
    expect(page.locator("body")).to_contain_text("VisibleChar")
    expect(page.locator("body")).not_to_contain_text("HiddenChar")

    # Direct URL to hidden char shows "not found"
    page.goto(f"{live_server}/test/character/{hidden_uuid}/")
    page.wait_for_load_state("domcontentloaded")
    expect(page.locator("body")).to_contain_text("does not exist")

    # As orga: hidden char is visible and accessible
    logout(page)
    login_orga(page, live_server)
    go_to(page, live_server, f"test/character/{hidden_uuid}/")
    expect(page.locator("body")).to_contain_text("hidden teaser")
...
def _test_character_locked(page: Any, live_server: Any, char_counter: list) -> None:
    ...
    login_user(page, live_server)
    go_to(page, live_server, "test/")
    expect(page.locator("body")).to_contain_text("LockedChar")

    # Character page shows public teaser but NOT private text
    go_to(page, live_server, f"test/character/{locked_uuid}/")
    expect(page.locator("body")).to_contain_text("locked teaser")
    expect(page.locator("body")).not_to_contain_text("locked private text")
    ...
    login_orga(page, live_server)
    go_to(page, live_server, f"test/character/{locked_uuid}/")
    expect(page.locator("body")).to_contain_text("locked private text")
...
def _test_faction_hide(page: Any, live_server: Any, char_counter: list, faction_counter: list) -> None:
    ...
    expect(page.locator("body")).to_contain_text("visible teaser")
    expect(page.locator("body")).not_to_contain_text("visible text")
    logout(page)
    login_orga(page, live_server)
    ...
    login_user(page, live_server)
    go_to(page, live_server, "test/")
    expect(page.locator("body")).not_to_contain_text("FactionHiddenChar")
    ...
    expect(page.locator("body")).to_contain_text("fhidden teaser")
...
def _test_faction_locked(page: Any, live_server: Any, char_counter: list, faction_counter: list) -> None:
    ...
    login_user(page, live_server)
    go_to(page, live_server, "test/")
    expect(page.locator("body")).to_contain_text("FactionLockedChar")

    # Character page shows public teaser but NOT private text
    go_to(page, live_server, f"test/character/{char_uuid}/")
    expect(page.locator("body")).to_contain_text("flocked teaser")
    expect(page.locator("body")).not_to_contain_text("flocked private text")
    ...
    login_orga(page, live_server)
    go_to(page, live_server, f"test/character/{char_uuid}/")
    expect(page.locator("body")).to_contain_text("flocked private text")
