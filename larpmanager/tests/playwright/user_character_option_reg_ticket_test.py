...
def prepare(page: Any) -> None:
    ...
    page.locator("#uglipop_popbox").get_by_role("searchbox").fill("st")
    page.locator("#uglipop_popbox .select2-results__option").first.click()
    ...
    page.locator("#uglipop_popbox").get_by_role("searchbox").click()
    page.locator("#uglipop_popbox").get_by_role("searchbox").fill("bam")
    page.locator("#uglipop_popbox .select2-results__option").first.click()
    submit_confirm(page, "uglipop_popbox")
