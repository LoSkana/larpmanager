...
class TestOrgaAccountingViews:
    ...
    def test_orga_discounts(self, user_with_permissions, event, run):
    ...
    def test_orga_discounts_edit(self, user_with_permissions):
    ...
    def test_orga_expenses_my(self, user_with_permissions, event, run):
    ...
    def test_orga_expenses_my_new_get(self, user_with_permissions, event, run):
    ...
    def test_orga_expenses_my_new_post_valid(self, user_with_permissions, event, run):
    ...
    def test_orga_invoices(self, user_with_permissions, event, run):
    ...
    def test_orga_invoices_confirm(self, user_with_permissions, event, run, payment_invoice):
    ...
    def test_orga_invoices_confirm_wrong_run(self, user_with_permissions, event, run, payment_invoice):
        request = self.factory.get("/test/manage/invoices/1/confirm/")
        request.user = user_with_permissions
    ...
    def test_orga_accounting(self, user_with_permissions, event, run):
    ...
    def test_orga_expenses_approve(self, user_with_permissions, event, run):
    ...
    def test_orga_expenses_approve_disabled(self, user_with_permissions, event, run):
        request = self.factory.get("/test/manage/expenses/1/approve/")
        request.user = user_with_permissions
...
@pytest.mark.django_db
class TestExeAccountingViews:
    """Test executive accounting views"""

    def setup_method(self):
        self.factory = RequestFactory()

    def test_exe_outflows(self, user_with_permissions):
    ...
    def test_exe_outflows_edit(self, user_with_permissions):
    ...
    def test_exe_year_accounting_valid_year(self, user_with_permissions):
    ...
    def test_exe_year_accounting_invalid_year(self, user_with_permissions):
    ...
    def test_exe_run_accounting(self, user_with_permissions, run):
    ...
    def test_exe_run_accounting_wrong_assoc(self, user_with_permissions, run):
        request = self.factory.get(f"/manage/run/{run.id}/accounting/")
        request.user = user_with_permissions
    ...
    def test_exe_balance(self, user_with_permissions, association):
    ...
    def test_check_year_with_post(self, association):
    ...
    def test_check_year_invalid_year(self, association):
    ...
    def test_exe_verification_manual(self, user_with_permissions, payment_invoice):
    ...
    def test_exe_verification_manual_wrong_assoc(self, user_with_permissions, payment_invoice):
        request = self.factory.get(f"/manage/verification/{payment_invoice.id}/manual/")
        request.user = user_with_permissions
    ...
    def test_exe_verification_manual_already_verified(self, user_with_permissions, payment_invoice):
        request = self.factory.get(f"/manage/verification/{payment_invoice.id}/manual/")
        request.user = user_with_permissions
...
@pytest.mark.django_db
class TestUserAccountingViews:
    """Test user accounting views"""

    def setup_method(self):
        self.factory = RequestFactory()

    def test_accounting(self, user_with_permissions):
    ...
    def test_accounting_redirect_no_assoc(self, user_with_permissions):
        request = self.factory.get("/accounting/")
        request.user = user_with_permissions
    ...
    def test_accounting_tokens(self, user_with_permissions):
    ...
    def test_accounting_credits(self, user_with_permissions):
    ...
    def test_acc_refund_get(self, user_with_permissions):
    ...
    def test_acc_refund_post_valid(self, user_with_permissions):
    ...
    def test_acc_collection_redeem(self, user_with_permissions):
    ...
    def test_acc_collection_redeem_post(self, user_with_permissions):
    ...
    def test_acc_collection_redeem_wrong_status(self, user_with_permissions):
        request = self.factory.get("/accounting/collection/ABC123/redeem/")
        request.user = user_with_permissions
        request.assoc = {"id": 1}
    ...
    def test_acc_payed(self, user_with_permissions, payment_invoice):
    ...
    def test_acc_payed_no_invoice(self, user_with_permissions):
...
@pytest.fixture
def payment_invoice(user_with_permissions, association, payment_method):
