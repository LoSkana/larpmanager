...
def remember_membership(registration: Any) -> None:
    ...
    body = get_association_text(
        get_run_basic_cache(registration.run_id)["association_id"],
...
def get_remember_pay_body(context: dict, registration: Registration, *, is_provisional: bool) -> str:
    ...
    email_body += get_payment_info(get_run_basic_cache(registration.run_id)["association_id"], payment_url)
...
def get_remember_membership_fee_body(context: dict, registration: Any) -> str:
    ...
    email_body += get_payment_info(get_run_basic_cache(registration.run_id)["association_id"], membership_url)
