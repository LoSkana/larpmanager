...
from larpmanager.utils.core.common import clean_html, get_elements, html_clean
...
def show_char(context: dict, element: dict | str | None, run: Run, include_tooltip: int) -> str:
    ...
    if "max_ch_number" not in context:
        context["max_ch_number"] = get_elements(run.event_id, Character).aggregate(Max("number"))["number__max"]
